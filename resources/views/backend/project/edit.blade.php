                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter English Service Name" value="{{ $project->title['en'] }}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ar" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter Arabic Service Name" value="{{ $project->title['ar'] }}"
                                            dir="rtl">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc_en" class="form-control" id="exampleInputEmail1" placeholder="Enter English Description">{{ $project->description['en'] }}</textarea>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc_ar" class="form-control" id="exampleInputEmail1" placeholder="Enter Arabic Description"
                                            dir="rtl">{{ $project->description['ar'] }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ URL::to($project->image) }}" style="width: 70px; height: 50px;">
