                ...
                <div class="card card-primary">
                    ...
                    <form action="{{ route('galleries.update', $gallery->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_en" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter English Service Name" value="{{ $gallery->title['en'] }}">
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title_ar" class="form-control" id="exampleInputEmail1"
                                            placeholder="Enter Arabic Service Name" value="{{ $gallery->title['ar'] }}"
                                            dir="rtl">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc_en" class="form-control" id="exampleInputEmail1" placeholder="Enter English Description">{{ $gallery->description['en'] }}</textarea>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea name="desc_ar" class="form-control" id="exampleInputEmail1" placeholder="Enter Arabic Description"
                                            dir="rtl">{{ $gallery->description['ar'] }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">{{ __('Gallery Photo') }}</label>
                                <div class="input-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <img src="{{ URL::to($gallery->photo) }}" style="width: 70px; height: 50px;">
